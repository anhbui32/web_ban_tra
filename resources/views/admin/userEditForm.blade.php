        ...
        <div class="row g-4">
            <div class="">
                <div class="bg-secondary rounded p-4" style="height: 670px">
                    ...
                    @endif
                    <form method="post" action="{{ route('users.update', $userIn->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div style="width: 570px">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="id" class="form-control w-25"
                                        value="{{ $userIn->id }}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Số điện thoại</label>
                                    <input type="text" name="phone_number" class="form-control" id=""
                                        value="{{ $userIn->phone_number }}" aria-describedby="">
                                    @error('phone_number')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                        value="{{ $userIn->email }}" aria-describedby="emailHelp">
                                    @error('email')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div style="width: 570px">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <img src="{{ asset('uploads/' . $userIn->image) }}" alt="Chưa có hình ảnh"
                                            class="img-thumbnail" style="max-width: 100px; max-height: 80px">
                                        <input type="file" name="file_media" class="form-control" id="avatar"
                                            accept="image/*">
                                    </div>
                                    @error('file_media')
                                        <span style="color: red">{{ $message }}</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="user_name" class="form-control" id=""
                                        value="{{ $userIn->user_name }}" aria-describedby="">
                                    @error('user_name')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="address" class="form-control" id=""
                                        value="{{ $userIn->address }}" aria-describedby="">
                                    @error('address')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="role" class="form-control"
                                        value="{{ $userIn->role_id }}" id="exampleInputPassword1">
                                    @error('role')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
